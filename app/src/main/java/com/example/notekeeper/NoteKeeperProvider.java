...
//        sUriMatcher.addURI(NoteKeeperProviderContract.AUTHORITY, Notes.PATH + "/#", NOTES_EXPANDED_ROW);
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriMatch) {
            ...
            case COURSES_ROW:
                ...
                rowSelectionArgs = new String[] {Long.toString(rowId)};
                db.delete(CourseInfoEntry.TABLE_NAME, rowSelection, rowSelectionArgs);
                break;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        switch (uriMatch) {
            ...
            case COURSES:
                ...
                break;
            case NOTES_EXPANDED:
                // throws exception indicating this is a read only table
                break;
        }
...
//                rowSelectionArgs = new String[] {Long.toString(rowId)};
//                cursor = notesExpandedQuery(db, projection, rowSelection, rowSelectionArgs, sortOrder);
//                break;
        }
    ...
    private Cursor notesExpandedQuery(SQLiteDatabase db, String[] projection, String selection,
        ...
        return db.query(tablesWithJoin, columns, selection, selectionArgs, null, null,
                sortOrder);
    }
